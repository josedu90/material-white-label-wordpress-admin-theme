    ...
    if ( ! class_exists( 'redukCoreEnqueue' ) ) {
        class redukCoreEnqueue {
            ...
            private function set_localized_data() {
                 ...
                 */
                $save_pending = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/save_pending", __( 'You have changes that are not saved. Would you like to save them now?', 'mtrl_framework' ) );
                 ...
                 */
                $reset_all = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/reset", __( 'Are you sure? Resetting will lose all custom values.', 'mtrl_framework' ) );
                 ...
                 */
                $reset_section = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/reset_section", __( 'Are you sure? Resetting will lose all custom values in this section.', 'mtrl_framework' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/preset", __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'mtrl_framework' ) );
                global $pagenow;
