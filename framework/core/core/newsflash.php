<?php
    ...
    if ( ! class_exists( 'redukNewsflash' ) ) {
        class redukNewsflash {
            private $parent = null;
            private $notice_data = '';
            private $server_file = '';
            private $interval = 3;
            ...
            public function __construct( $parent, $params ) {
                ...
                $fname = Reduk_Functions::bub( 'get_notice_json', $parent->args['opt_name'] );
                $mname = Reduk_Functions::yo( 'display_message', $parent->args['opt_name'] );
                    ...
                    if ( $data != '' || ! empty( $data ) ) {
                        ...
                        if ( ! empty( $this->notice_data ) ) {
                            if ( strcmp( $data, $this->notice_data ) == 0 ) {
                                ...
                                Reduk_Functions::setCookie( $this->cookie_id, time(), time() + ( 86400 * $this->interval ), '/' );
            ...
            private function display_message() {
                ...
                if ( ! empty( $this->notice_data ) ) {
                    ...
                    if ( is_array( $data ) && ! empty( $data ) ) {
                        ...
                        if ( $data['type'] == 'reduk-message' ) {
                            $data['type'] = 'updated reduk-message';
                        }
