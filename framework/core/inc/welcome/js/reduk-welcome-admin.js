(function( $ ) {
    ...
    $.reduk_welcome = $.reduk_welcome || {};

    $( document ).ready(
        function() {
            $.reduk_welcome.initQtip();
            if ( jQuery( document.getElementById( "support_div" ) ).is( ":visible" ) ) {
                $.reduk_welcome.initSupportPage();
            }
            $.reduk_welcome.supportHash();
        }
    );


    $.reduk_welcome.supportHash = function() {
        ...
        jQuery( '.reduk_support_hash' ).click(
            function( e ) {
                ...
                var $nonce = jQuery( '#reduk_support_nonce' ).val();
                ...
                jQuery.ajax(
                    {
                        ...
                        success: function( response ) {
                            if ( response.status == "success" ) {
                                jQuery( '#support_hash' ).val( 'http://support.reduk.io/?id=' + response.identifier );
    ...
    $.reduk_welcome.initSupportPage = function() {
        //jQuery time
    ...
    $.reduk_welcome.initQtip = function() {
        if ( $().qtip ) {
