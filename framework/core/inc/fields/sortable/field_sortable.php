...
if ( ! class_exists( 'RedukFramework_sortable' ) ) {
    class RedukFramework_sortable {

        /**
         * Field Constructor.
         * Required - must call the parent constructor, then assign field and value to vars, and obviously call the render field function
         *
         * @since Reduk_Options 2.0.1
         */
        ...
        function render() {
            ...
            echo '<ul id="' . $this->field['id'] . '-list" class="reduk-sortable ' . $class . ' ' . $label_class . '">';
        ...
        function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-sortable-css',
                    RedukFramework::$_url . 'inc/fields/sortable/field_sortable.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'reduk-field-sortable-js',
                RedukFramework::$_url . 'inc/fields/sortable/field_sortable' . Reduk_Functions::isMin() . '.js',
