...
(function( $ ) {
    ...
    reduk.field_objects.gallery = reduk.field_objects.gallery || {};

    $( document ).ready(
        function() {
            //reduk.field_objects.gallery.init();
        }
    );

    reduk.field_objects.gallery.init = function( selector ) {


        if ( !selector ) {
            selector = $( document ).find( '.reduk-container-gallery:visible' );
        }
                                ...
                                'update', function( selection ) {
                                    ...
                                    var ids = selection.models.map(
                                        function( e ) {
                                            ...
                                            preview_html = "<a class='of-uploaded-image' href='" + preview_img + "'><img class='reduk-option-image' src='" + preview_img + "' alt='' /></a>";
                                    ...
                                    reduk_change( current_gallery.find( '.gallery_values' ) );
