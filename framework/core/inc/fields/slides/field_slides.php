...
if ( !class_exists ( 'RedukFramework_slides' ) ) {
    ...
    class RedukFramework_slides {
        ...
        public function render () {
            ...
            echo '<div class="reduk-slides-accordion" data-new-content-title="' . esc_attr ( sprintf ( __ ( 'New %s', 'mtrl_framework' ), $this->field[ 'content_title' ] ) ) . '">';
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion reduk-slides-remove">' . __ ( 'Delete', 'mtrl_framework' ) . '</a></li>';
            ...
            if ( $x == 0 ) {
                echo '<div class="reduk-slides-accordion-group"><fieldset class="reduk-field" data-id="' . $this->field[ 'id' ] . '"><h3><span class="reduk-slides-header">' . esc_attr ( sprintf ( __ ( 'New %s', 'mtrl_framework' ), $this->field[ 'content_title' ] ) ) . '</span></h3><div>';
            ...
            echo '</div><a href="javascript:void(0);" class="button reduk-slides-add button-primary" rel-id="' . $this->field[ 'id' ] . '-ul" rel-name="' . $this->field[ 'name' ] . '[title][]' . $this->field['name_suffix'] .'">' . sprintf ( __ ( 'Add %s', 'mtrl_framework' ), $this->field[ 'content_title' ] ) . '</a><br/>';
        }
