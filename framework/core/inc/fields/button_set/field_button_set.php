...
// Don't duplicate me!
    if ( ! class_exists( 'RedukFramework_button_set' ) ) {

        /**
         * Main RedukFramework_button_set class
         *
         * @since       1.0.0
         */
        class RedukFramework_button_set {
            ...
            public function enqueue() {
                ...
                if (!wp_script_is ( 'reduk-field-button-set-js' )) {
                    wp_enqueue_script(
                        'reduk-field-button-set-js',
                        RedukFramework::$_url . 'inc/fields/button_set/field_button_set' . Reduk_Functions::isMin() . '.js',
                        array( 'jquery', 'jquery-ui-core', 'reduk-js' ),
                        time(),
                        true
                    );
                }
