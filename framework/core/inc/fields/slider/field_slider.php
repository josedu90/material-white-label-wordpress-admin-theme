...
if ( ! class_exists( 'RedukFramework_slider' ) ) {
    class RedukFramework_slider {
        ...
        function enqueue() {
            ...
            wp_enqueue_style(
                'reduk-nouislider-css',
                RedukFramework::$_url . 'inc/fields/slider/vendor/nouislider/reduk.jquery.nouislider.css',
                array(),
                '5.0.0',
                'all'
            );
            ...
            wp_register_script(
                'reduk-nouislider-js',
                RedukFramework::$_url . 'inc/fields/slider/vendor/nouislider/reduk.jquery.nouislider' . $min . '.js',
                array( 'jquery' ),
                '5.0.0',
                true
            );
            ...
            wp_enqueue_script(
                'reduk-field-slider-js',
                RedukFramework::$_url . 'inc/fields/slider/field_slider' . $min . '.js',
                array( 'jquery', 'reduk-nouislider-js', 'reduk-js', 'select2-js' ),
                time(),
                true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-slider-css',
                    RedukFramework::$_url . 'inc/fields/slider/field_slider.css',
                    array(),
                    time(),
                    'all'
                );
        ...
        function render() {
            ...
            if ( $this->display_text == $this->field['display_value'] ) {
                ...
                echo '<input type="text"
                         ...
                         id="' . $idOne . '"
                         value="' . $valOne . '"
                         class="reduk-slider-input reduk-slider-input-one-' . $fieldID . ' ' . $this->field['class'] . '"/>';
            ...
            // LABEL output
                ...
                echo '<div class="reduk-slider-label' . $labelNum . '"
                       id="reduk-slider-label-one-' . $fieldID . '"
                       name="' . $nameOne . '">
                  </div>';
            ...
            // SELECT output
                ...
                echo '<select class="reduk-slider-select-one reduk-slider-select-one-' . $fieldID . ' ' . $this->field['class'] . '"
                          name="' . $nameOne . '"
                          id="' . $idOne . '">
                 </select>';
            }
            ...
            echo 
            '<div
                class="reduk-slider-container ' . $this->field['class'] . '"
                id="' . $fieldID . '"
                data-id="' . $fieldID . '"
            ...
            if ( true == $twoHandles ) {
                ...
                if ( true == $showInput ) {
                    echo '<input type="text"
                             ...
                             id="' . $idTwo . '"
                             value="' . $valTwo . '"
                             class="reduk-slider-input reduk-slider-input-two-' . $fieldID . ' ' . $this->field['class'] . '"/>';
                }

                // LABEL
                if ( true == $showLabel ) {
                    echo '<div class="reduk-slider-label-two"
                           id="reduk-slider-label-two-' . $fieldID . '"
                           name="' . $nameTwo . '">
                      </div>';
                }
                ...
                // SELECT
                if ( true == $showSelect ) {
                    echo '<select class="reduk-slider-select-two reduk-slider-select-two-' . $fieldID . ' ' . $this->field['class'] . '"
                              name="' . $nameTwo . '"
                              id="' . $idTwo . '">
                     </select>';
            ...
            if ( $this->display_none == $this->field['display_value'] || $this->display_label == $this->field['display_value'] ) {
                echo '<input type="hidden"
                         class="reduk-slider-value-one-' . $fieldID . ' ' . $this->field['class'] . '"
                         name="' . $nameOne . '"
                         id="' . $idOne . '"
                         value="' . $valOne . '"/>';
                ...
                if ( true == $twoHandles ) {
                    echo '<input type="hidden"
                             class="reduk-slider-value-two-' . $fieldID . ' ' . $this->field['class'] . '"
                             name="' . $nameTwo . '"
                             id="' . $idTwo . '"
                             value="' . $valTwo . '"/>';
                }
