...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'RedukFramework_textarea' ) ) {
        class RedukFramework_textarea {

            /**
             * Field Constructor.
             *
             * @param       $value  Constructed by Reduk class. Based on the passing in $field['defaults'] value and what is stored in the database.
             * @param       $parent RedukFramework object is passed for easier pointing.
             *
            ...
            function render() {
                ...
                // The $this->field variables are already escaped in the RedukFramework Class.
                ?>
