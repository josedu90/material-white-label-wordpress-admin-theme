...
if ( ! class_exists( 'RedukFramework_palette' ) ) {
    class RedukFramework_palette {
        ...
        public function render() {
            ...
            foreach ( $this->field['palettes'] as $value => $colorSet ) {
                ...
                echo '<input type="radio" value="' . $value . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="reduk-palette-set ' . $this->field['class'] . '" id="' . $this->field['id'] . '-' . $value . '"' . $checked . '>';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'reduk-field-palette-js',
                RedukFramework::$_url . 'inc/fields/palette/field_palette' . $min . '.js',
                array( 'jquery', 'reduk-js', 'jquery-ui-button', 'jquery-ui-core' ),
                time(),
                true
            );  
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-palette-css',
                    RedukFramework::$_url . 'inc/fields/palette/field_palette.css',
                    array(),
                    time(),
                    'all'
                );
