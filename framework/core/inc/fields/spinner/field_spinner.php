...
if ( ! class_exists( 'RedukFramework_spinner' ) ) {
    class RedukFramework_spinner {
        ...
        function render() {
            ...
            echo '<div id="' . $this->field['id'] . '-spinner" class="reduk_spinner" rel="' . $this->field['id'] . '">';
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                'reduk-field-spinner-custom-js',
                RedukFramework::$_url . 'inc/fields/spinner/vendor/spinner_custom.js',
                array( 'jquery' ),
                time(),
                true
            );
            ...
            wp_enqueue_script(
                'reduk-field-spinner-js',
                RedukFramework::$_url . 'inc/fields/spinner/field_spinner' . Reduk_Functions::isMin() . '.js',
                array(
                    'jquery',
                    'reduk-field-spinner-custom-js',
                    'jquery-ui-core',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-spinner-css',
                    RedukFramework::$_url . 'inc/fields/spinner/field_spinner.css',
                    array(),
                    time(),
                    'all'
                );
