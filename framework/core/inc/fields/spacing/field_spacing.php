...
//            }
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="reduk-spacing-all reduk-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'All', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-all" value="' . $this->value['top'] . '"></div>';
            }
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                 ...
                 * */
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="reduk-spacing-top reduk-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Top', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-top" value="' . $this->value['top'] . '"></div>';
                }
                 ...
                 * */
                if ( $this->field['right'] === true ) {
                    echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="reduk-spacing-right reduk-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Right', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-right" value="' . $this->value['right'] . '"></div>';
                }
                 ...
                 * */
                if ( $this->field['bottom'] === true ) {
                    echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="reduk-spacing-bottom reduk-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Bottom', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
                }
                 ...
                 * */
                if ( $this->field['left'] === true ) {
                    echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="reduk-spacing-left reduk-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Left', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
                }
            }
            ...
            if ( $this->field['units'] !== false && is_array( $this->field['units'] ) /* && !isset($absolute) */ && $this->field['display_units'] == true ) {
                ...
                echo '<select data-placeholder="' . __( 'Units', 'mtrl_framework' ) . '" class="reduk-spacing reduk-spacing-units select ' . $this->field['class'] . '" original-title="' . __( 'Units', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '" id="' . $this->field['id'] . '_units">';
