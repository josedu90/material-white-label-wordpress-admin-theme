...
// Don't duplicate me!
if ( !class_exists ( 'RedukFramework_divide' ) ) {

    /**
     * Main RedukFramework_divide class
     *
     * @since       1.0.0
     */
    class RedukFramework_divide {
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-divide',
                    RedukFramework::$_url . 'inc/fields/divide/field_divide.css',
                    array(),
                    time(),
                    'all'
                );
