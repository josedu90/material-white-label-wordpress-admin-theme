...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'RedukFramework_sorter' ) ) {
        class RedukFramework_sorter {

            /**
             * Field Constructor.
             * Required - must call the parent constructor, then assign field and value to vars, and obviously call the render field function
             *
             * @since Reduk_Options 1.0.0
             */
            ...
            function render() {
                ...
                if ( is_array( $sortlists ) ) {
                    ...
                    if ( $sortlists ) {
                        echo '<fieldset id="' . esc_attr($this->field['id']) . '" class="reduk-sorter-container reduk-sorter">';
            ...
            function enqueue() {
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'reduk-field-sorder-css',
                        RedukFramework::$_url . 'inc/fields/sorter/field_sorter.css',
                        array(),
                        time(),
                        'all'
                    );
                ...
                wp_enqueue_script(
                    'reduk-field-sorter-js',
                    RedukFramework::$_url . 'inc/fields/sorter/field_sorter' . Reduk_Functions::isMin() . '.js',
                    array( 'jquery', 'reduk-js', 'jquery-ui-sortable' ),
                    time(),
                    true
                );
            }
