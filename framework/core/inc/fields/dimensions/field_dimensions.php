        ...
        class RedukFramework_dimensions {
            ...
            function render() {
                ...
                if ( $this->field['width'] === true ) {
                    ...
                    echo '<input type="text" class="reduk-dimensions-input reduk-dimensions-width mini ' . $this->field['class'] . '" placeholder="' . __( 'Width', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-width" value="' . filter_var( $this->value['width'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( $this->field['height'] === true ) {
                    ...
                    echo '<input type="text" class="reduk-dimensions-input reduk-dimensions-height mini ' . $this->field['class'] . '" placeholder="' . __( 'Height', 'mtrl_framework' ) . '" rel="' . $this->field['id'] . '-height" value="' . filter_var( $this->value['height'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
                    ...
                    echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . __( 'Units', 'mtrl_framework' ) . '" class="reduk-dimensions reduk-dimensions-units select ' . $this->field['class'] . '" original-title="' . __( 'Units', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
