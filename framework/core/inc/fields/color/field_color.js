...
(function( $ ) {
    ...
    reduk.field_objects.color = reduk.field_objects.color || {};
    ...
    reduk.field_objects.color.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( ".reduk-group-tab:visible" ).find( '.reduk-container-color:visible' );
        }
...
//				var $control = el.find( '.reduk-color-init' ),
//                                        
...
//				$( '<div class="reduk-alpha-container">'
...
//                                //console.log($alpha);
//				$alpha_output = $control.parents( '.wp-picker-container:first' ).find( '.reduk-alpha-container output' );
...
//                                        el.find( '.reduk-color-init' ).wpColorPicker( 'color', iris._color.toString() );
